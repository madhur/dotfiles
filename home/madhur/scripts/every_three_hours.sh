...
#    run_with_notification "cd /home/madhur/github/python-scripts/process-rewardable-events && /home/madhur/.virtualenvs/python-scripts-yxaz/bin/python /home/madhur/github/python-scripts/process-rewardable-events/reward_dup_watch.py" "Reward Dup Watch → Mailpit" "monitoring"
    ...
    run_with_notification "cd /home/madhur/github/python-scripts/temporal && /home/madhur/.virtualenvs/python-scripts-yxaz/bin/python /home/madhur/github/python-scripts/temporal/list_failed_workflows_watch.py --env-file .env_stage --label stage-600309" "Temporal Failed Workflows (stage-600309)" "monitoring"
