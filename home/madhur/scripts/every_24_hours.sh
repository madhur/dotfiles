...

{
    ...
    # Disabled — superseded by docker_digest.py (stopped/unhealthy callout covers this).
    # run_with_notification "/home/madhur/scripts/container-restart-digest.sh" "Container Restart Digest → n8n" "monitoring"
    run_with_notification "/home/madhur/scripts/pacman-summary.sh" "Pacman Activity Summary → n8n" "monitoring"
