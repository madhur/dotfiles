...
Run a locust controller on different port
    locust -f fantasy_connection_service/controller/kafka_publish_test_controller.py --host localhost:8080 --web-port 8087 
