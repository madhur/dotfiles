...
local clientkeys = gears.table.join(awful.key({altkey, shiftkey}, "space", lain.util.magnify_client, {
...
--     end
-- ),
awful.key({modkey, shiftkey}, "a", function(c)
...
awful.key({modkey}, "w", function()
    if cl_menu then
        ...
        for i = 1, #tag:clients() do
            ...
            if not awful.rules.match(cl, {
                class = "Conky"
            }) then
                client_list[i] = {prefix .. cl.name, function()
