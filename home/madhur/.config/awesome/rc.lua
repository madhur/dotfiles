...
local layouts = {awful.layout.suit.tile.right, -- Like tall layout, master on left
bling.layout.centered, -- three col mid
bling.layout.mstab, bling.layout.vertical, bling.layout.equalarea, -- grid
...
tag.connect_signal("request::default_layouts", function()
    awful.layout.append_default_layouts({awful.layout.suit.tile.right, lain.layout.termfair, bling.layout.mstab,
                                         lain.layout.termfair.center, lain.layout.centerwork, bling.layout.centered,
                                         bling.layout.deck, bling.layout.vertical, bling.layout.horizontal,
